...
from .views import adm_agregar_prod,adm_agregar_user,adm_index,adm_modificar_prod,eliminar_producto,adm_modificar_user,eliminar_user,adm_productos,adm_regist_compras,adm_regist_users,index,adm_detalle_registro
