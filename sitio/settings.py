...
SECRET_KEY = 'django-insecure-nn06w(!ld&d_#2t#8otn+b$5r5o6+h-(871p3)3%d8os%-15gy'
...
INSTALLED_APPS = [
    ...
    'crud',
    'django.contrib.humanize', # Preguntar 
    'crispy_forms',  # Corregido el nombre del paquete
    "crispy_bootstrap5",
]
